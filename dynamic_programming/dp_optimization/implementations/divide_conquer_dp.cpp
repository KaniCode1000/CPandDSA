...
void compute(int l, int r, int optl, int optr, vector<long long> &dp_before, vector<long long> &dp_cur) {
	if (l > r)
		return;
...
long long solve(vector<long long> &dp_before, vector<long long> &dp_cur){
